...
static const char col_gray2[]       = "#1E2030"; // inactive background / borders
static const char col_gray3[]       = "#CCD0DA"; // foreground
static const char col_gray4[]       = "#181926"; // bright foreground / selected text
static const char col_cyan[]        = "#F5BDE6"; // selection 
...
static const Key keys[] = {
	...
	{ MODKEY|Mod4Mask,              XK_9,      incrovgaps,     {.i = +1 } }, { MODKEY|Mod4Mask|ShiftMask,    XK_9,      incrovgaps,     {.i = -1 } },
